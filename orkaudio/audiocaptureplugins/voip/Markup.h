...
public:
	...
	~CMarkup();
	//////////////////////////////////////////////////////////////////////////
	bool HasAttrib( MCD_CSTR szAttrib ) const;
	bool HasChildAttrib( MCD_CSTR szAttrib ) const;
	...
	int GetElemLevel() const;

	bool Open( MCD_CSTR szFileName, int nDocFlags, MCD_STR* pstrEncoding=NULL );
	bool Close();
	bool Flush();
	bool FindPrevElem( MCD_CSTR szName = NULL );
	bool FindPrevChildElem( MCD_CSTR szName = NULL );

	bool RemoveAttrib( MCD_CSTR szAttrib );
	bool RemoveChildAttrib( MCD_CSTR szAttrib );
	...
	void GotoElemIndex( int nIndex );

	int GetDocElemCount() const;


protected:
	static bool x_ReadTextFile( MCD_CSTR_FILENAME szFileName, MCD_STR& strDoc, MCD_STR* pstrResult=NULL, int* pnDocFlags=NULL, MCD_STR* pstrEncoding=NULL );
